context("check evenstrings")

test_that("special cases (eg. NA) are handeld right", {

  expect_equal(evenstrings(NA, split = "", char = 6),
               list())
  expect_equal(evenstrings(c(), split = "", char = 6),
               list())
  expect_equal(evenstrings("", split = "", char = 6),
               list())
  expect_equal(evenstrings(NULL, split = "", char = 6),
               list())
  expect_equal(evenstrings(NaN, split = "", char = 6),
               list())

})

test_that("examplpes are working with correct length", {
  ...
  expect_true(all(sapply(res1, nchar) < 30))
