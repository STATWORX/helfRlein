#' @title a debugging function to dive in
#' 
#' @description 
...
#' @author Andre Bleier
#' @note Version 1.0 - 09adcdad5a26fa0f8739434b36c02d106e340ed2
#' 
#                            )    O
#                           (   o . O
#                            )   () .
...
dive <- function(x, return = "cons") {
  ...
  # fix x.args due to ,
  open <- stringr::str_count(x.args, "\\(")
  open[1] <- open[1] - 1
  close <- as.numeric(stringr::str_count(x.args, "\\)"))
